...
describe("ES5 generated from parsing typescript", function(){
	it("typescript generated es5 class decorator, as well as overridden methods and extended class should be traversed correctly",function(done){

		var testFolder = "ts_base_scenario";
	...
	it("when class is not extended, should be parsed without errors", function(done){
