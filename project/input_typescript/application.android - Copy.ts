...
//         onActivityCreated: function (activity: android.app.Activity, savedInstanceState: android.os.Bundle): void {
...
//                     androidApp.onActivityCreated(activity, savedInstanceState);
//                 }
//             }
...
//         onActivityDestroyed: function (activity: android.app.Activity): void {
//             //if (!(activity instanceof (<any>com).tns.NativeScriptActivity)) {
//             //    return;
//             //}
...
//         onActivityPaused: function (activity: android.app.Activity): void {
//             //if (!(activity instanceof (<any>com).tns.NativeScriptActivity)) {
//             //    return;
//             //}
...
//         onActivityResumed: function (activity: android.app.Activity): void {
//             //if (!(activity instanceof (<any>com).tns.NativeScriptActivity)) {
//             //    return;
//             //}
...
//         onActivitySaveInstanceState: function (activity: android.app.Activity, outState: android.os.Bundle): void {
//             //if (!(activity instanceof (<any>com).tns.NativeScriptActivity)) {
//             //    return;
//             //}
...
//                 androidApp.onSaveActivityState(activity, outState);
//             }
//         },

//         onActivityStarted: function (activity: android.app.Activity): void {
//             //if (!(activity instanceof (<any>com).tns.NativeScriptActivity)) {
//             //    return;
//             //}
...
//         onActivityStopped: function (activity: android.app.Activity): void {
//             //if (!(activity instanceof (<any>com).tns.NativeScriptActivity)) {
//             //    return;
//             //}
...
//     // public getActivity(intent: android.content.Intent): void {
...
//         // topFrame.android.onActivityRequested(intent);
//     // }
